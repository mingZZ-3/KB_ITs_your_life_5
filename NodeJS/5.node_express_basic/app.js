...
// post(post x-www-form-urlencoded) 처리를 적용 ---> post에 있는 body를 데이터로 인식할 수 있음
...
// path 3가지 패턴이 올 수 있다. '/'=root, ['/',  '/index', '/home'],  '^home*[0-9]*$' = 정규식도 가능
app.get(['/',  '/index', '/home'], (req, res) => {
    res.status(200);
    res.render('home'); // app.set('views', __dirname + '/home') 로 인해 경로 생략 가능
    // res.render(__dirname + '/views' + '/home'); // 이건 안돌아 감
});
